...
/** 初始化字体 */
bool GLFont::InitFont(int size)
{
 
  /**< 创建字体 */
   m_hFont = CreateFont(size,					/**< 字体高度 */
						0,						/**< 字体宽度 */
...
/** 在指定位置输出字符串 */
void GLFont::PrintText(const char *string, float x, float y)
{
	...
	SetTextColor(hDC, RGB(0, 0, 255));      /**< 字体颜色白色 */
